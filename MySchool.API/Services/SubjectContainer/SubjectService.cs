...
namespace MySchool.API.Services.SubjectContainer
{
        ...
        ) : IServiceInjector
    {
        ...
        public async Task<IBaseResponse<object>> UpdateSubjectAsync(int SubjectId, SubjectRequestDto updatedSubject)
        {
            var Repository = unitOfWork.GetRepository<Subject>();
        ...
        public async Task<IBaseResponse<object>> DeleteSubjectByIdAsync(int SubjectId)
        {
            var Repository = unitOfWork.GetRepository<Subject>();
            var Entity = await Repository.GetByIdAsync(SubjectId);
